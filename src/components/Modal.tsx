...
const Modal = ({ title, onClose, children }: Props) => {
	return (
		<>
			<div className="backdrop fixed top-0 right-0 w-full h-full bg-[#000b]"></div>
			<div className="modal-segment fixed top-0 right-0 w-full h-full flex items-center justify-center">
